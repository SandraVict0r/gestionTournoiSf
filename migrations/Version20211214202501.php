 ...
 */
final class Version20211214202501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe CHANGE nom nom VARCHAR(15) NOT NULL, CHANGE tournoi_id trn_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equipe CHANGE nom nom VARCHAR(20) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE trn_id tournoi_id INT NOT NULL');
