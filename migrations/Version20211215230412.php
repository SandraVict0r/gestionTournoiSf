 ...
 */
final class Version20211215230412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur ADD eqp_id INT DEFAULT NULL, DROP equipe_id, DROP nom, CHANGE niveau niveau VARCHAR(15) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE joueur ADD equipe_id INT NOT NULL, ADD nom VARCHAR(15) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, DROP eqp_id, CHANGE niveau niveau VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`');
